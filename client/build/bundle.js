...
/***/ function(module, exports, __webpack_require__) {
	...
	var CountriesBox = React.createClass({
	  ...
	  setBorderingCountries: function setBorderingCountries(countries) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(CountrySelect, { countries: this.state.countries, onSelectCountry: this.setSelectedCountry, captureSelectCountryBorderingCountries: this.setBorderingCountries }),
	      React.createElement(CountryInfoBox, { country: this.state.selectedCountry, borderingCountries: this.state.borderingCountries })
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CountrySelect = React.createClass({
	  ...
	  countryToOption: function countryToOption(country, index) {
	    return React.createElement(
	      "option",
	      { key: index },
	      " ",
	  ...
	  countriesAsOptions: function countriesAsOptions() {
	  ...
	  findSelectedCountry: function findSelectedCountry(index) {
	    var result = this.props.countries[index];
	    return result;
	  },
	
	  captureBorderingCountriesCodes: function captureBorderingCountriesCodes(country) {
	    console.log("bordering country codes", country.borders);
	    return country.borders;
	  },
	  captureBorderingCountries: function captureBorderingCountries(countriesCodesArray) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "select",
	        { value: this.selectedIndex, onChange: this.handleChange },
	        options
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Country = __webpack_require__(162);
	
	var CountryInfoBox = React.createClass({
	  displayName: 'CountryInfoBox',
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(Country, { key: 0, countryInfo: this.props.country, borderingCountries: this.props.borderingCountries })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Country = React.createClass({
	  ...
	  render: function render() {
	    ...
	    if (!this.props.countryInfo) return React.createElement('div', null);
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        null,
	        ' SubRegion: ',
	        this.props.countryInfo.subregion,
	        ' '
	      ),
	      React.createElement(
	        'ul',
	        ...
	        React.createElement(
	          ...
	          null,
	          ' German: ',
	          this.props.countryInfo.translations.de,
	          ' '
	        ),
	        React.createElement(
	          'li',
	          null,
	          ' Spanish: ',
	          this.props.countryInfo.translations.es,
	          ' '
	        ),
	        React.createElement(
	          'li',
	          null,
	          ' French: ',
	          this.props.countryInfo.translations.fr,
	          ' '
	        ),
	        React.createElement(
	          'li',
	          null,
	          ' Italian: ',
	          this.props.countryInfo.translations.it,
	          ' '
	        ),
	        React.createElement(
	          'li',
	          null,
	          ' Japanese: ',
	          this.props.countryInfo.translations.ja,
	          ' '
	        )
	      ),
	      React.createElement(
